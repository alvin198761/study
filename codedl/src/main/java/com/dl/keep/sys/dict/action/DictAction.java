package com.dl.keep.sys.dict.action;
...
import com.dl.keep.sys.dict.service.IDictService;
import com.dl.keep.sys.dicttype.service.IDictTypeService;
...
public class DictAction {
	...
	public String toAdd(@ModelAttribute("dict") Dict dict, HttpSession session, String type_id, Integer typecode) {
	 ...
	 */
	@RequestMapping("/list")
	public String queryList(Map<String, Object> map, @ModelAttribute("cond") DictCond cond,
