...
<body>
	<form:form name="form1" id="form1" method="post" commandName="param">
		...
		<center class="btn_div">
			...
			<input type="button" class="bnt" onclick="toAction('${webPath}/param/list')" value="返回" />
		</center>
	</form:form>
</body>
