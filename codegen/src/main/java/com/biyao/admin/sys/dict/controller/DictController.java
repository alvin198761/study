package com.biyao.admin.sys.dict.controller;
...
public class DictController {
	...
	public String toAdd(@ModelAttribute("dict") Dict dict, HttpSession session, @RequestParam String typeid, @RequestParam String typecode) {
		dict.setType_id(typeid);
	...
	public String Add(Map<String, Object> map, @ModelAttribute("dict") Dict dict, BindingResult result) {
		...
		service.insert(dict);
		return "redirect:/dict/list?typeid=" + dict.getType_id();
	}
	/**
	 * 后台验证
	 */
	...
	public String delete(Map<String, Object> map, @RequestParam String id, @RequestParam String typeid) {
		service.delete(id);
		return "redirect:/dict/list?typeid=" + typeid;
	}
	/**
	 * 跳转到修改页面
	 */
	 ...
	 */
	@RequestMapping("/list")
	public String queryList(Map<String, Object> map, @ModelAttribute("cond") DictCond cond ,@RequestParam("typeid") String typeid ) {
		map.put("dicttype", typeService.findById(typeid));
		cond.setType_id_c(typeid);
