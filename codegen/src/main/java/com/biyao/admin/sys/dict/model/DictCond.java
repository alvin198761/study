...
public class DictCond extends BaseCondition {
	...
	public void addCondition() {
		add(type_code_c, " AND T.TYPE_CODE LIKE ?", 3);
		add(data_key_c, " AND T.DATA_KEY LIKE ?", 3);
	...
	private String type_code_c;// 类型编码
	private String data_key_c;// 数据键
	private String data_value_c;// 数据值
	private String type_id_c;// 类型名称
	private String remark_c;// 备注
	private Date ts_c;// 时间戳

	public String getType_code_c() {
		return type_code_c;
	}
	public void setType_code_c(String type_code_c) {
		this.type_code_c = type_code_c;
	}
	public String getData_key_c() {
		return data_key_c;
	}
	public void setData_key_c(String data_key_c) {
