package com.biyao.admin.sys.roleUser.dao.impl;
...
import com.biyao.admin.sys.roleUser.dao.IRoleUserDao;
...
public class RoleUserDaoImpl  extends BaseDao  implements IRoleUserDao {
	...
	public int[] insertBatch(final List<RoleUser> list) {
		...
		sb.append("INSERT INTO SYS_ROLE_USER (ID,ROLE_ID, USER_ID,TS,REMARK) VALUES (?,?,?,?,?)");
