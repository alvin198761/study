package com.biyao.admin.sys.sysfunc.service.impl;
...
public class SysFuncServiceImpl implements ISysFuncService {
	...
	public String getLimtCondition(String resourceType, String user_id) {
		...
		try {
			String condition = utilDao.getLimtCondition(resourceType, user_id);
			if (!condition.equals("")) {
				limtCondition = " AND FUNCTION_ID " + condition;
			}
		} catch (Exception e1) {
