package com.biyao.admin.sys.user.controller;
...
import com.biyao.admin.sys.roleUser.service.IRoleUserService;
...
public class UserController {
	...
	@Autowired
	private DictionaryUtil du;// 数据字典辅助类
	...
	public String toAdd(Map<String, Object> map, @ModelAttribute("user") User user, HttpSession session) {
		map.put("sexmap", du.getSelect("1", false));
