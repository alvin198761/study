...
<center class="btn_div">
	<input type="button" icon="icon-apply" value="确定" onclick="javascript:do_Authority('${role.id}');" /> <input type="button" icon="icon-close"
		value="关闭" onclick="top.dhxWins.window('win001').close();" />
</center>
<div id="treebox"></div>
</body>
<script type="text/javascript">
	...
	setTimeout("tree.openAllItems(0)", 100);
