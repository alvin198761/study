	...
	<form:form name="form1" id="form1" method="post" action="" commandName="para">
		...
		<table class="SearchTab">
			...
			<tr>
				...
				<td align="right"><input type="button" icon="icon-search" value="查询" onclick="toAction('${webPath}/code/list')" /></td>
		...
		<table class="titleTab">
			<tr>
				...
				<td class="bu">
				<input type="button" icon="icon-retry" value="清空自定义" onclick="clear_onclick()" />
				<input type="button" icon="icon-add" value="生成代码" onclick="add_onclick(getIds())" /></td>
			</tr>
		</table>
		<table class="dataTab">
			<tr>
