...
<body>
	...
	<table class="titleTab">
		<tr>
			...
			<td class="bu">
				<input type="button" icon="icon-add" onclick="toAction('${webPath}/sysfunc/toAdd?id=${sysfunc.func_id}')" value="新增下级"/> 
				<input type="button" icon="icon-edit" onclick="toAction('${webPath}/sysfunc/toUpdate?id=${sysfunc.func_id}')" value="编辑"/> 
	...
	<table class="dataTab">
		...
		<tr>
			...
			<td><fmt:formatDate value="${sysfunc.ts}" type="both" /></td>
