...
<script type="text/javascript">
	...
	function toClear() {//清空查询条件
		clearCond(['name_c','type_c','is_leaf_c','url_c','parent_id_c','order_code_c','remark_c','dr_c','ts_c']);
	}
	...
	<form:form id="form1" method="post" commandName="cond">
		...
		<table class="SearchTab">
			...
			<tr>
				...
				<td></td>
				<td>
					<input type="button" icon="icon-search" value="查询" onclick="toAction('${webPath}/sysfunc/list');" /> 
		...
		<table class="titleTab">
			<tr>
				...
				<td class="bu">
					<input type="button" icon="icon-add" value="新增" onclick="toAction('${webPath}/sysfunc/toAdd?id=${cond.parent_id_c}');" />
