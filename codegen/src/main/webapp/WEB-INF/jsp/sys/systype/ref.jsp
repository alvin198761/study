...
<script type="text/javascript">
	...
	tree.loadXML("${webPath}/systype/tree?id=1&type=${param.type}");
	...
	function returnValue() {
		...
		$(top.frames['center'].document).find('#${param.rvalue}').val(id);
		$(top.frames['center'].document).find('#${param.rname}').val(tree.getItemText(id));
