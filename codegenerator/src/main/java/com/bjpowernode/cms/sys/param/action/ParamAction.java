package com.bjpowernode.cms.sys.param.action;
...
public class ParamAction {
	...
	public String toInsert(@ModelAttribute("param") Param param) {
	...
	public String delete(Map<String, Object> map, String ids) {
		service.delete(ids);
		return "redirect:/param/list";
	}
